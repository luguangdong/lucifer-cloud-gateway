pipeline {
    ...
    environment{
            ...
            gitUrl = "http://192.168.137.200/lucifer-cloud/lucifer-cloud-gateway.git"
    ...
    parameters {
          ...
          hidden name: 'publisher_remoteDirectory', defaultValue: '/data/deploy/lucifer-cloud/gateway/', description:'ssh远程文件夹'
